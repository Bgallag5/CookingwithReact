...
export default function Recipe(props) {
    ...
    //destructure props into the workable data we need 
    //call the js data in our JSX (html) code 
    const { recipeName, cookTime, servings, instructions, ingredients, id } = props;
